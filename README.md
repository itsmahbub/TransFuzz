...
- **Precomputed Experiment Results**  
  Precomputed outputs for all fuzzing configurations reported in the paper, including fault-inducing inputs and logs recording coverage, fault discovery, and runtime statistics.
