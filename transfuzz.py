...
if __name__ == "__main__":
    ...
    seeds_dataset = model_wrapper.get_seeds(dataset_name=args.seed_dataset, preprocessed=False, split=args.split, count=args.seed_count)
    seeds_dataset = filter_incorrect(seeds_dataset, model_wrapper, batch_size=args.N, preprocessed=False)

    seeds_dataset_preprocessed = model_wrapper.get_seeds(dataset_name=args.seed_dataset, preprocessed=True, split=args.split, count=args.seed_count)
